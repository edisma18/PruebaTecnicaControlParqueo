...
{
    public partial class _DefaultMain : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("RegistraEntrada.aspx");
        }
        ...
        {
            Response.Redirect("UpdateCarros.aspx");
        }

        protected void btnSalida_Click(object sender, EventArgs e)
        {
            Response.Redirect("RegistraSalida.aspx");
        }
    }
}
