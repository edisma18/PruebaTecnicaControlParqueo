<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegistraSalida.aspx.cs" Inherits="Solution.UI.Web.RegistraSalida" %>
...
<body>
    <script type="text/Javascript" language ="javascript" >  
        function showAlert() {
            alert("El vehículo no se encuentra dentro del parqueo!");
        }
    ...
    <div>
        ...
        <asp:Panel ID="Panel1" runat="server" GroupingText="Registrar Salida de Vehículos">
            <table class="style1">
                <tr>
                    <td>
                        Placa                    
                ...
                <tr>
                    <td>
                        ...
                        <asp:Button ID="btnEnviar" runat="server" Text="Registrar Salida" Width="128px" OnClick="btnEnviar_Click" /><asp:Button ID="btnBack" runat="server" onclick="btnBack_Click" 
                    ...
                    <td>
                        Monto a Pagar:  ctual:  <asp:Label runat="server" ID="lblPago"></asp:Label></td>
                </tr>
                <tr>
                    <td>
                        &nbsp;
