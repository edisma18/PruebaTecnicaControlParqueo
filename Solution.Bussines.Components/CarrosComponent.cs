...
{
    public class CarrosComponent
    {
        /// <summary>
        /// Submit an Customers.
        /// </summary>
        /// <param name="Customers">An Customers object.</param>
        public Carros CreateCarro(Carros carro)
        {
            ...
            Console.WriteLine("New Carro = " + carro.Placa);
        ...
        /// </summary>
        /// <param name="customers">An Customers object.</param>
        private Carros CreateCustomers(Carros carro)
        {
            // Business logic.
